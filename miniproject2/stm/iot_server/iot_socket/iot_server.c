...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","1","PASSWD"}, \
				...
				{0,-1,"","user4","PASSWD"},  {0,-1,"","user3","PASSWD"}, \
				{0,-1,"","user2","PASSWD"},  {0,-1,"","user1","PASSWD"}, \
				{0,-1,"","KSH_SQL","PASSWD"},  {0,-1,"","KSH_BT","PASSWD"}, \
				{0,-1,"","KSH_STM32","PASSWD"},  {0,-1,"","KSH_LIN","PASSWD"}, \
				{0,-1,"","KSH_AND","PASSWD"},  {0,-1,"","KSH_ARD","PASSWD"}, \
				{0,-1,"","HM_CON","PASSWD"}};
